...
export default function LegalClientPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-background to-purple-100/50">
      <header className="border-b border-border bg-background/80 backdrop-blur-md sticky top-0 z-10">
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center gap-4">
            <Link href={role === "cliente" ? "/dashboard" : "/dashboard/legal"}>
      ...
      <main className="container mx-auto px-6 py-8 space-y-8">
        ...
        <JudicialFullSection clientId={client.id} clientName={client.name} clientEmail={client.email || undefined} userRole={role} />
      </main>
    </div>
  )
}
